...
void Init(int argc, char **argv){
   ...
   prepara_textura("./puente_rio.jpg", &textura_id);
	 prepara_textura("./mago.jpg", &textura_id2);
}
...
void dibuja (void)
{
   ...
   glVertexPointer(3, GL_FLOAT, 0, vertices); ///numero de vertices o 2d o 3d  //primer parametro
